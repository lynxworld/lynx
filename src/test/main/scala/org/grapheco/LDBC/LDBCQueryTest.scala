...
//
  ...
  def Q5(): Unit = {
    ...
    val p = Map("personId" -> update_person_ids(0), "minDate" -> LynxDate(LocalDate.of(1800,1,1)))
    run(q,p)
  }
  ...
  def Q6(): Unit = {
    ...
    val p = Map("personId" -> update_person_ids(0), "tagName" -> "Carl_Gustaf_Emil_Mannerheim")
    run(q,p)
  }
  ...
  def Q10(): Unit = {
    ...
    val p = Map("personId" -> update_person_ids(0), "month" -> 5)
    run(q,p)
  }
  ...
  def Q12(): Unit = {
    ...
    val p = Map("personId" -> update_person_ids(0), "tagClassName" -> "Carl_Gustaf_Emil_Mannerheim")
    run(q,p)
  }
  ...
  def Q13(): Unit = {
    ...
    val p = Map("person1Id" -> update_person_ids(0), "person2Id" -> update_person_ids(2))
    run(q,p)
  }
  ...
  def u1(): Unit = {
    ...
    val p = Map("cityId" -> "500000000000111", "personId" -> update_person_ids(0),
  ...
  def u3(): Unit ={
    ...
    val p = Map("personId" -> update_person_ids(1),
  ...
  def u5(): Unit ={
    ...
    val p = Map("personId" -> update_person_ids(2),
  ...
  def u8(): Unit ={
    ...
    val p = Map(
      "person1Id" -> update_person_ids(8),
      "person2Id" -> update_person_ids(9),
      "creationDate" -> LynxDate.today)
    run(q, p)
