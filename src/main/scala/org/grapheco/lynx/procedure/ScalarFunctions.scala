...
class ScalarFunctions {
  ...
  def id(x: LynxValue): LynxInteger = x match {
    ...
    case _ => throw ProcedureException("id() can only used on node or relationship.")
  }
  ...
  def toBoolean(x: LynxValue): LynxValue = {
    x match {
      ...
      case _ => throw ProcedureException("toBoolean conversion failure")
    }
  }
  ...
  def toFloat(x: LynxValue): LynxValue = {
    x match {
      ...
      case _ => throw ProcedureException("toFloat conversion failure")
    }
  }
  ...
  def toInteger(x: LynxValue): LynxValue = {
    x match {
      ...
      case _ => throw ProcedureException("toInteger conversion failure")
    }
  }
